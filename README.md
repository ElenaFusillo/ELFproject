...
- estimate of the so-called DPA (_distanza di prima approssimazione_) for the given configuration at \'lim_val\' microTesla. Suggested lim_values: 3 or 10 µT [D.P.C.M. 08.07.2003][3].
