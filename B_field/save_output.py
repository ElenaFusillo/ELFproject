...
def write_file(full_destination_txt, subparser_output):
    '''TODO docstring
    ...
    with open(full_destination_txt, "a") as output_file:
        output_file.write(str(subparser_output))
        output_file.write('\n')

def save_output_txt(dest, name_file, subparser_output):
    '''TODO docstring'''
    full_destination = full_dest_txt(dest, name_file)
    write_file(full_destination, subparser_output)
