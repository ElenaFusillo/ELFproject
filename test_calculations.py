...
import numpy as np
import pytest
from B_field import cli, calculations

#UNIT TESTING

def test_calc_B_phasors_overhead(eg_input_OH, eg_output_B_phasors_OH):
    '''
    ...
    what is expected to.
    '''
    calculated_B_phasors = calculations.calc_B_phasors(eg_input_OH[0], eg_input_OH[1], eg_input_OH[2], eg_input_OH[3][0])
...
def test_main_single(eg_input_OH, eg_output_B_eff_single_OH, eg_input_UG, eg_output_B_eff_UG):
    '''
    ...
    '''
    calculated_main_single_OH = calculations.main_single(eg_input_OH[0], eg_input_OH[1], eg_input_OH[2], eg_input_OH[3])
