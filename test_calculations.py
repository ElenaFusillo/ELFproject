...
def test_calc_B_phasors_OH(eg_input_single_OH, eg_output_B_phasors_OH):
    '''
    Tests:
...
def test_calc_B_phasors_UG(eg_input_UG, eg_output_B_phasors_UG):
    '''
    Tests:
    calc_B_phasors numpy array output element-wise
...
def test_calc_B_effective_single_OH(eg_input_B_eff_single_OH, eg_output_single_OH):
    '''
    Tests:
...
def test_calc_B_effective_single_UG(eg_input_B_eff_UG, eg_output_UG):
    '''
    Tests:
    calc_B_effective function output
...
def test_calc_B_effective_double_OH(eg_input_B_eff_double_OH, eg_output_double_OH):
    '''
    Tests:
    calc_B_effective function output
...
def test_main_point_single_OH(eg_input_single_OH, eg_output_single_OH):
    '''
    Tests:
...
def test_main_point_single_UG(eg_input_UG, eg_output_UG):
    '''
    Tests:
    main_point function output
...
def test_main_point_double_OH(eg_input_double_OH, eg_output_double_OH):
    '''
    Tests:
    main_point function output
...
def test_main_grid_single_OH(eg_input_single_OH, eg_output_single_OH):
    '''
    Tests:
...
def test_main_grid_single_UG(eg_input_UG, eg_output_UG):
    '''
    Tests:
    main_grid function output
...
def test_main_grid_double_OH(eg_input_double_OH, eg_output_double_OH):
    '''
    Tests:
    main_grid function output
...
def test_centroid_single_OH(eg_input_single_OH, eg_output_single_OH):
    '''
    Tests:
...
def test_centroid_single_UG(eg_input_UG, eg_output_UG):
    '''
    Tests:
    centroid function output
...
def test_centroid_double_OH(eg_input_double_OH, eg_output_double_OH):
    '''
    Tests:
    centroid function output
...
def test_is_underground_single_OH(eg_input_single_OH, eg_output_single_OH):
    '''
    Tests:
...
def test_is_underground_single_UG(eg_input_UG, eg_output_UG):
    '''
    Tests:
    is_underground function output
...
def test_is_underground_double_OH(eg_input_double_OH, eg_output_double_OH):
    '''
    Tests:
    is_underground function output
...
def test_lim_val_checker_single_OH(eg_output_single_OH):
    '''
    Tests:
...
def test_lim_val_checker_single_UG(eg_output_UG):
    '''
    Tests:
    lim_val_checker function output
...
def test_lim_val_checker_double_OH(eg_output_double_OH):
    '''
    Tests:
    lim_val_checker function output
...
def test_main_dpa_single_OH(eg_input_single_OH, eg_output_single_OH):
    '''
    Tests:
...
def test_main_dpa_single_UG(eg_input_UG, eg_output_UG):
    '''
    Tests:
    main_dpa function output
...
def test_main_dpa_double_OH(eg_input_double_OH, eg_output_double_OH):
    '''
    Tests:
    main_dpa function output
